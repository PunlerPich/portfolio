...
export default function Real_Estest() {
  return (
    <>
          ...
          <div className="md:col-span-2">
            <div className="p-2">
              <Image
                ...
                src="https://firebasestorage.googleapis.com/v0/b/bel-news-99264.appspot.com/o/images%2F123.jpg?alt=media&token=a8090dae-f0c6-4f16-96e9-34dc63305166"
              />
            </div>
          </div>
          <div className="pr-5 py-2 ">
            <div className="mb-5 shadow-md p-5 rounded-lg">
              ...
              <p className="text-sm text-justify pb-2">
                This website create for Real_Estest that User can view detail
                product like buy or rent house
              </p>
              <Divider />
            </div>
