...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-10 sm:py-10 justify-start flex-shrink-0 [perspective:1000px] transform md:scale-100  scale-50 ">
      <motion.h2
        style={{
